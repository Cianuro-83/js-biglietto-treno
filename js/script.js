...
// Dichiaro giorno acquisto biglietto
const today = new Date();
const year = date.getFullYear();
console.log("La data di richiesta acquisto biglietto è la seguente:", year);
...
console.log(
  "Con lo sconto del 20% il costo del tuo biglietto è di €",
...
console.log(
  "Con lo sconto del 40% il costo del tuo biglietto è di €",
